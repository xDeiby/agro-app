...
export async function getAllRels(id: string, entity_index: EntityRelated): Promise<EntityBaseSearch<GeoPointTs>[]> {
...
export function getRelValues(entity: EntityBaseSearch<GeoPointTs>): { label: string; value: string } {
